...
const Edit = ({ auth, carrito_producto }) => {
    ...
    const { data, setData, patch, processing, reset, errors } = useForm({
        id: carrito_producto.data.id,
        producto_id: carrito_producto.data.producto_id,
        carrito_id: carrito_producto.data.carrito_id,
    ...
    const submit = (e) => {
        ...
        patch(`/carrito_producto/update`, carrito_producto.data.id);
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Editar carrito_producto</h2>}
        >
            <Head title="Editar carrito_producto" />
            <div className="py-12 ">
